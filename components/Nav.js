...
export default function Nav({ show }) {
  const inactiveLink =
    "flex gap-1 p-1 hover:bg-highlight hover:text-black rounded-sm  transition duration-300 ease-in";
  const activeLink = inactiveLink + " bg-highlight text-black rounded-sm";
  const inactiveIcon = "w-6 h-6 hover:text-primary";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all duration-500"
      }
    >
